 ...
 *
 */
public class TopLayout extends Composite implements HasText {

	private static TopLayoutUiBinder uiBinder = GWT.create(TopLayoutUiBinder.class);

	interface TopLayoutUiBinder extends UiBinder<Widget, TopLayout> {
	}
